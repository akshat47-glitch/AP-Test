function Footer() {
  return (
    <div class="bg-slate-900 px-4 pb-7 md:px-0 md:pt-10">
      <div class="text-md flex w-full flex-col space-y-5 px-4 pt-8 md:flex-row md:justify-center md:space-x-4 md:space-y-0 md:pt-0 lg:space-x-16">
        <div>
          <div class="mb-[13px] font-semibold text-slate-100">
            <span class="font-en">LIVE EVENTS</span>
          </div>
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Vedant Mahotsav</span>
          </div>
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Gita Course</span>
          </div>
          <div class="text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Institutional Sessions</span>
          </div>
        </div>
        <div>
          <div class="mb-[13px] font-semibold text-slate-100">
            <span class="font-en">WISDOM CONTENT</span>
          </div>
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Wisdom Courses</span>
          </div>
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">His Books</span>
          </div>
          <div class="text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">AP Circle</span>
          </div>
        </div>
        <div>
          <div class="mb-[13px] font-semibold text-slate-100">
          ...
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">About Acharya Prashant</span>
          </div>
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Ghar Ghar Upanishad</span>
          </div>
          <div class="mb-[10px] text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Media and Public Interaction</span>
          </div>
          <div class="text-slate-300 hover:cursor-pointer hover:text-brand-700">
            <span class="font-en">Talks with Acharya Prashant</span>
          </div>
        </div>
        <div>
          <div class="mb-[13px] font-semibold text-slate-100">
            <span class="font-en">SOCIAL MEDIA</span>
          </div>
          <div class="mb-6 flex flex-col ">
            <div class="mb-[10px] text-slate-300">
              <span class="font-en">For English</span>
            </div>
          ...
          <div class="flex flex-col">
            <div class="mb-[10px] text-slate-300">
              <span class="font-en">For Hindi</span>
            </div>
            <div class="flex space-x-2">
              <div class="text-slate-300 hover:text-brand-700">
                <a
        ...
        <div>
          <div class="mb-[13px] pt-2 font-semibold text-slate-100 md:hidden">
            <span class="font-en">DOWNLOAD ACHARYA PRASHANT APP</span>
          </div>
          <div class="mb-[13px] hidden font-semibold text-slate-100 md:block">
            <span class="font-en">DOWNLOAD APP</span>
          </div>
          <div class="mb-5 hidden items-center md:flex">
            <img
              class="mr-2 h-6 w-6"
            ...
            <div class="text-slate-100">
              <span class="font-en">Acharya Prashant</span>
            </div>
          </div>
          <div class="flex md:flex-col">
            <div class="mr-4 h-8 w-28 md:mr-0 md:mb-5 md:w-[114px]">
              <a
                target="_blank"
              ...
              >
                <img
                  ...
                  class="rounded-md border-[1.4px] border-slate-300"
                />
              </a>
            </div>
            <div class="h-8 w-28 md:w-[114px]">
              <a
                target="_blank"
        ...
        <div class="space-y-3 pt-2 md:pt-0">
          <div class="mb-[13px] font-semibold text-slate-100 md:pb-0">
          ...
          <div class="mb-[10px] flex items-center">
            ...
            <a href="mailto:support@advait.org.in">
              <div class="text-slate-300 hover:text-brand-700">
                <span class="font-en">support@advait.org.in</span>
              </div>
            </a>
          </div>
          <div class="mb-[13px] flex items-center">
            ...
            <a href="https://wa.me/+919643750710" target="_blank">
              <div class="text-slate-300 hover:text-brand-700">
                <span class="font-en">+91 9650585100</span>
              </div>
            </a>
          </div>
          ...
          <div class="flex w-1/2 cursor-pointer items-center justify-center rounded border border-white py-[5px] text-sm text-slate-100 hover:border-brand-700 hover:text-brand-700 md:w-10/12">
            <span class="font-en">Fill Form to Connect</span>
          </div>
        </div>
      </div>
      <div class="mx-auto mt-6 mb-6 h-[0.5px] w-full bg-slate-400 md:mt-[62px] md:w-2/3"></div>
      <div class="flex-col text-xs md:mx-auto md:flex md:flex-row md:justify-center md:text-sm">
        <div class="text-slate-300 md:pr-20">
          <span class="font-en">
        ...
        <div class="flex space-x-2 pt-2 md:pt-0">
          <a
            ...
            class="cursor-pointer text-slate-300 hover:text-brand-700"
          >
            <span class="font-en">Terms &amp; Conditions</span>
          </a>
          ...
          <a
            ...
            class="cursor-pointer text-slate-300 hover:text-brand-700"
          >
            <span class="font-en">Privacy Policy</span>
          </a>
        </div>
      </div>
      <div class="pb-14"></div>
